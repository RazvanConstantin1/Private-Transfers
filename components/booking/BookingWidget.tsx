              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 p-3.5">
                    <div className="relative w-20 h-14 rounded-lg overflow-hidden flex-shrink-0" style={{ background: 'var(--bg-card)' }}>
                      <Image src={vehicle.imageUrl} alt={vehicle.name} fill className="object-cover" sizes="80px" priority={index === 0} />
                    </div>
